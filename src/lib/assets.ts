...
teachers: [
    { name: 'Meghnath Sharma', img: meghnathSharma, role: 'Head Teacher', subject: 'Mathematics', category: 'Teacher' },
    { name: 'Prakash Acharya', img: prakashAcharya, role: 'Assist. Head Teacher', subject: 'English', category: 'Teacher' },
    ...
    { name: 'Bharat Sharma', img: bharatSharma, role: 'Co-Ordinator (Primary Level)', subject: 'Social Studies', category: 'Teacher' },
    ...
    { name: 'Liladhar Paudel', img: liladharPaudel, role: 'Co-Ordinator (9-12 General)', subject: 'Mathematics', category: 'Teacher' },
    ...
    { name: 'Parsu Adhikari', img: parsuAdhikari, role: 'Co-Ordinator (9-10 General)', subject: 'Science', category: 'Teacher' },
